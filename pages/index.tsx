...
export default function Home() {
  ...
  return (
    <>
      <Head>
        <title>Robert Seghedi | Home</title>
      </Head>
      <Header />
      <div className="h-screen w-screen flex justify-center items-center">
        <div className="flex flex-col items-center">
          <motion.h1 initial={{opacity: 0}} animate={{opacity: 1}} className="text-9xl font-bold text-center sm:text-5xl md:text-7xl">{"Hi, I'm Robert"}</motion.h1>
          <motion.p initial={{opacity: 0}} animate={{opacity: 1}} className="text-4xl mt-5 text-gray-800 text-center sm:text-xl md:text-3xl mx-5">The one that is shaping the apps that you'll use tomorrow.</motion.p>
